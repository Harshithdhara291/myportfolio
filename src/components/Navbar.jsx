...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 px-4 bg-black text-white fixed'>
        <div>
            <h1 className='text-5xl font-logo ml-2'>Harshith</h1>
        </div>
        ...
        {nav && <ul className='flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-t from-black to-gray-800 text-gray-500'> 
            {links.map(({id,link})  => (
